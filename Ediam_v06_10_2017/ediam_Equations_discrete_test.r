...
#Auxiliaries in Advanced Region
    # Price_Y.N<-ifelse(t==0,Price_Y0.N,Price_Y.N)
     cR.N <- Price.oil/Price.final.N
     epsi_re.N<-epsi_re.N #this is the cost of production of clean technologies
     epsi_ce.N<-epsi_ce.N  #this is the cost of production of dirty technologies
...
#Emerging Region
    ...
    # Price_Y.S<-ifelse(t==0,Price_Y0.S,Price_Y.S)
     cR.S <- Price.oil/Price.final.S
     epsi_re.S<-epsi_re.S #this is the cost of production of clean technologies
     epsi_ce.S<-epsi_ce.S #this is the cost of production of dirty technologies
	   L.S<-L.S.Data(t)
...
#======================================================================================================================================================
 ...
 #Evolution of Productivity Advanced Region
     A_re.N.t1<-Eta_re.N*s_re.N*A_re+(1-s_re.N*Eta_re.N)*A_re.N
     A_ce.N.t1<-Eta_ce.N*s_ce.N*A_ce+(1-s_ce.N*Eta_ce.N)*A_ce.N

 #Evolution of Productivity Emerging Region
     A_re.S.t1<-Eta_re.S*s_re.S*A_re+(1-s_re.S*Eta_re.S)*A_re.S
     A_ce.S.t1<-Eta_ce.S*s_ce.S*A_ce+(1-s_ce.S*Eta_ce.S)*A_ce.S
