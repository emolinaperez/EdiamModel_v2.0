...
#incloud
  dir.model<<-"C:\\Users\\Administrator\\Documents\\Edmundo\\Projectos\\TechChange-RDM\\TechChange Model\\Ediam_v27_09_2017\\"
  dir.data<-"C:\\Users\\Administrator\\Documents\\Edmundo\\Projectos\\TechChange-RDM\\TechChange Model\\Ediam_v27_09_2017\\CalibrationScripts\\CalibrationData\\"
#in pc
  dir.model<<-"C:\\Users\\L03054557\\Edmundo-ITESM\\Proyectos\\Disertation\\Model Disertation\\TechChange Model\\Ediam_v27_09_2017\\"
  dir.data<-"C:\\Users\\L03054557\\Edmundo-ITESM\\Proyectos\\Disertation\\Model Disertation\\TechChange Model\\Ediam_v27_09_2017\\CalibrationScripts\\CalibrationData\\"
#
...
#primary energy supply 1990 OECD: 4525.760 [million toe]  1 toe = 3.968*1e7 BTU  ;(4525.760*1e6*3.968*1e7)/1e15
  ...
  ValVars<<-c("Y.N","Y_ce.N","Y_re.N","Y.S","Y_ce.S","Y_re.S")
...
#                    Eta_re.S = round(0.01,2),
#                    Eta_ce.S = round(0.01,2),
#                     A_re0.N = 1.0,
#                     A_ce0.N = 1.0 ,
#                     A_re0.S = 1.0 ,
#                     A_ce0.S = 1.0
...
#
 calib.params<<-c( alfa.N = round(x[1],3),
...
#Estimate mean square differences
   ...
   MSEp2<-((SimulData[,ValVars[4]]-Y_h.S)/Y_h.S)^2
...
#Check constraints
  ...
  #                    ifelse(mean(MSEp1.2)<=0.0025,
  #                            ifelse(mean(MSEp2)<=0.0025,
  #                                ifelse(mean(MSEp2.1)<=0.0025,
  #                                     ifelse(mean(MSEp2.2)<=0.0025,
...
library(rgenoud)
genoud(ediamMSE,max=FALSE,nvars=16,
