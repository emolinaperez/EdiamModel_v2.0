...
#==========================================================================================================================================================================================================
 Parameters <- c(Run.ID = 1, #as.numeric(params['Run.ID'])
                ...
                #Technological paramters
                 ...
                 A_re0.N = as.numeric(calib.params['A_re0.N']),
                 A_ce0.N = as.numeric(calib.params['A_ce0.N']),
                 A_re0.S = as.numeric(calib.params['A_re0.S']),
                 A_ce0.S = as.numeric(calib.params['A_ce0.S'])
                )
...
#Determine initial conditions
 InitialConditions <-ediamInitialConditions( as.numeric(Parameters['alfa.N']),
...
#
InitialConditions <- c(A_re = max(as.numeric(InitialConditions['A_re.N'])*as.numeric(calib.params['A_re0.N']),
                                  as.numeric(InitialConditions['A_re.S'])*as.numeric(calib.params['A_re0.S'])),
                       A_ce = max(as.numeric(InitialConditions['A_ce.N'])*as.numeric(calib.params['A_ce0.N']),
                                  as.numeric(InitialConditions['A_ce.S'])*as.numeric(calib.params['A_ce0.S'])),
                       A_re.N = as.numeric(InitialConditions['A_re.N'])*as.numeric(calib.params['A_re0.N']),
                       A_ce.N = as.numeric(InitialConditions['A_ce.N'])*as.numeric(calib.params['A_ce0.N']),
                       A_re.S = as.numeric(InitialConditions['A_re.S'])*as.numeric(calib.params['A_re0.S']),
                       A_ce.S = as.numeric(InitialConditions['A_ce.S'])*as.numeric(calib.params['A_ce0.S']),
                       CO2.Concentration= as.numeric(InitialConditions['CO2.Concentration']) )
