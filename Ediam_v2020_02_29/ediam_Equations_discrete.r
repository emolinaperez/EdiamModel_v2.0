...
#Auxiliaries in Advanced Region
     ...
     L.N<-L.N.Data(t)
     epsilon.N_0 <- epsilon.N
     epsilon.N <- epsilon.N_0*(1-0.001*t) # Elasticity of Substitution
...
#Auxiliaries in Emerging Region
     ...
     L.S<-L.S.Data(t)
     epsilon.S_0 <- epsilon.S
     epsilon.S <- epsilon.S_0*(1-0.005*t) # Elasticity of Substitution
#First we determine the equilibrium levels of relative input prices and relative labor
